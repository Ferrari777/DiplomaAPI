...
namespace DiplomaAPI.Controllers
{
    ...
    public class DocumentController : Controller
    {
        ...
        public DocumentController(UserDbContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<ActionResult> Download(int id)
        {
            ...
            var file = Path.Combine(_webEnvironment.ContentRootPath, "Resources", "Documents", document.DocumentName);
